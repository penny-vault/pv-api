...
func init() {
	...
	serverCmd.Flags().String("server-allow-origins", "http://localhost:5174,http://localhost:9000,https://pennyvault.com,https://www.pennyvault.com", "comma-separated CORS origins to allow; empty disables CORS")
