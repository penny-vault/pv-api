...
func successPayload() email.Payload {
	return email.Payload{
		...
		SinceLabel:    "Tuesday",
		DeltaColor:    "#22c55e",
		Returns: []email.ReturnsRow{
			{
				Label:   "Portfolio",
				Day:     email.ReturnCell{Pct: "+1.2%", Color: "#16a34a"},
				Wtd:     email.ReturnCell{Pct: "+3.3%", Color: "#16a34a"},
				Mtd:     email.ReturnCell{Pct: "+7.7%", Color: "#16a34a"},
				Ytd:     email.ReturnCell{Pct: "-2.4%", Color: "#dc2626"},
